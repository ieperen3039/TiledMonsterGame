...
/**
 * Represents a node in an XML file. This contains the name of the node, a map of the attributes and their values, any
 * text data between the start and end tag, and a list of all its children nodes.
 * @author Karl
 */
public class XmlNode {
    ...
    /**
     * Gets a child node with a certain name, and with a given value of a given attribute. Used to get a specific child
     * when there are multiple child nodes with the same node name.
     * @param childName - the name of the child node.
    ...
    /**
     * Adds a new attribute to this node. An attribute has a name and a value. Attributes are stored in a HashMap which
     * is initialized in here if it was previously null.
     * @param attr  - the name of the attribute.
