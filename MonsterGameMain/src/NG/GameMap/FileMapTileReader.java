 ...
 */
public class FileMapTileReader {
    ...
    public static void readFile(File file, TileThemeSet sourceSet) {
        ...
        MapTile.registerTile(name, file.toPath(), pos_pos, pos_neg, neg_neg, neg_pos, MapTile.Properties.NONE, possibleOffset, sourceSet);
    }
}
